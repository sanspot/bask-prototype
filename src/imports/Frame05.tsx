import svgPaths from "./svg-pt14dmvt2l";
...
function Content() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col h-[1264.923px] items-start relative shrink-0 w-full" data-name="Content">
      <div className="bg-white h-[76px] relative shrink-0 w-full" data-name="Nav/Top Nav">
...
export default function Frame() {
  return (
    <div className="content-stretch flex flex-col items-start justify-between relative size-full" data-name="Frame05">
      <Content />
      <div className="bg-white content-stretch flex flex-col gap-[16px] items-start p-[16px] relative shrink-0 w-[393px]" data-name="Footer">
        ...
        <div className="bg-[#2a71e5] h-[44px] relative rounded-[8px] shrink-0 w-full" data-name="Button">
          <div className="flex flex-row items-center justify-center size-full">
            <div className="content-stretch flex items-center justify-center px-[16px] relative size-full">
              <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">Continue to Payment</p>
            </div>
          </div>
        </div>
        <div className="bg-white h-[44px] relative rounded-[8px] shrink-0 w-full" data-name="Button">
          <div aria-hidden="true" className="absolute border border-[#e4e4e4] border-solid inset-0 pointer-events-none rounded-[8px]" />
          <div className="flex flex-row items-center justify-center size-full">
            <div className="content-stretch flex items-center justify-center px-[17px] py-px relative size-full">
              <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#121212] text-[16px] text-center whitespace-nowrap">Back to Home</p>
            </div>
          </div>
        </div>
      </div>
